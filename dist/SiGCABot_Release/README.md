...
*   **Interfaz Gráfica Premium (Dark Mode):** Panel de control moderno basado en la paleta de colores *Catppuccin* oscuro. Cuenta con pestañas de configuración, visualizador de registros (consola de logs) y panel de monitoreo.
